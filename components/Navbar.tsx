                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link href="/write" className="text-gray-900 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                                    Write
                                </Link>
                            </div>
                        </div>
                ...
                {isOpen && (
                    ...
                    >
                        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                            ...
                            <Link href="/write" className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
                                Write
                            </Link>
                            <button
                                onClick={() => setIsDropdownOpen(!isDropdownOpen)}
